...
test(r"D:\bachelor_project\data_analysis\dataset\600_random_comments_politics.csv") #change file path here
#test(r"D:\bachelor_project\data_analysis\dataset\100_random_comments_sports.csv")
