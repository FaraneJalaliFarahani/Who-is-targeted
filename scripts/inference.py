...
if __name__ == "__main__":
    ...
    pd.read_csv (args.csv_file_output).to_excel (args.csv_file_output+'output.xlsx', index = None, header=True) 
    #print("jailbreaking count", count_empty)
